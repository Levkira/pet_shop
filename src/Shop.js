            ...
            <Container className='wrapper'>
                <Router>
                    <Menu pointing secondary>
                        ...
                        >
                            <NavLink to='/petshop/home' className='menu_link' activeClassName='menu_link_active'>Home</NavLink>
                        </Menu.Item>
                        <Menu.Item
                            as='p'
                            name='products'
                            ...
                            onClick={handleItemClick}
                        >
                            <NavLink to='/petshop/products' className='menu_link' >Products</NavLink>
                        </Menu.Item>
                        <Menu.Item
                            as='p'
                            name='cart'
                            ...
                            onClick={handleItemClick}
                        >
                            <NavLink to='/petshop/cart' className='menu_link' >Cart</NavLink>
                        </Menu.Item>
                    ...
                    <Switch>
                        <Route path='/petshop/home' exact>
                            <HomePage />
                        </Route>
                        <Route path='/petshop/products' exact>
                            <ProductsPage products={products} />
                        </Route>
                        <Route path='/petshop/cart' exact>
                            <CartPage />
                        </Route>
                    </Switch>
                </Router>
